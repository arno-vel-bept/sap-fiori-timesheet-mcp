...
See [Other MCP clients](../other-mcp-clients/) for what that writes and where.
...
Both locations can be moved with environment variables; see the [configuration reference](../../reference/configuration/). Why these two files exist and what they mean for security is explained in [How authentication works](../../explanation/how-authentication-works/).
