...
<Aside type="tip">
The examples use the BearingPoint portal and its codes (for example `0077` for administration). If your organisation runs its own SAP Fiori system, the steps are the same; only the launchpad URL and the codes differ. See [Use it with another SAP system](../../install/other-sap-systems/).
</Aside>
...
- Fill everything that is still open in one go: [Fill the whole open period](../../how-to/fill-open-period/).
- Book your staffing plan instead of typing codes: [Apply the staffing plan](../../how-to/apply-staffing/).
- Find the right codes for a project: [Jobcodes and codes](../../reference/jobcodes/).
