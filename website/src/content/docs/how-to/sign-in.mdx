...
<Aside type="caution">
Prefer `sso`. With credential mode your password passes through the tool (and, in an MCP configuration, may sit in a plain JSON file). Read [Security](../../explanation/security/#credential-mode) before using it.
</Aside>
