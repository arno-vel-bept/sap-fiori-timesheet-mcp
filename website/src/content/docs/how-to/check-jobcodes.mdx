...
For the Multiproject timesheet, the equivalent question is answered by `mp stats` / `mp_stats`; see [Project proportions](/sap-fiori-timesheet-mcp/how-to/project-proportions/).
